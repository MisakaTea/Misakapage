$(function(){
    ...
    var musicImgsData = ['img/bg.jpg','img/bg1.jpg','img/bg2.jpg','img/bg3.jpg']    // 图片地址数组
    var musicNameData = ['KICK BACK','多索雷斯假日','Ether Strike','Möbius'];                   // 歌曲名数组
    var artistNameData = ['米津玄师','塞壬唱片','Akira Complex','mpi/Laco/Benjamin/Hiroyuki Sawano']            // 创作歌手数组
    var musicUrls=['mp3/music1.mp3','mp3/music2.mp3','mp3/music3.mp3','mp3/music4.mp3'];// 歌曲mp3数组
